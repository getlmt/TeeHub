...
// Bạn có thể import ảnh từ folder assets hoặc dùng link online
...
const Home = () => {
  ...
  // Đã xóa mảng slides và useEffect slideshow
  ...
  return (
    <div className={styles.home}>
      {/* HERO SECTION ĐÃ SỬA: 
        Dùng ảnh tĩnh thay vì Slider. 
        Lưu ý: Bạn cần CSS để class .heroStaticWrapper đè hình ảnh xuống dưới text
      */}
      <section className={styles.hero}>
        
        {/* Lớp chứa ảnh nền tĩnh */}
        <div style={{
            position: 'absolute',
            top: 0,
            left: 0,
           ...
           <img 
             ...
             style={{
                 width: '100%',
                 height: '100%',
                 objectFit: 'cover', // Đảm bảo ảnh phủ kín khung
